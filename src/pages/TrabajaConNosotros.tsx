    ...
    <div className="sucursales-section" style={{ marginTop: '0px' }}>
      ...
      <div className="sucursales-container">
        <div className="responsive-row" style={{ display: 'flex', flexDirection: 'row', width: '100vw', minHeight: '100vh', alignItems: 'stretch' }}>
          <img src="/images/corporate/staff.png" alt="Imagen staff" className="trabaja-img" style={{ width: '50vw', height: '100%', maxHeight: '100vh', objectFit: 'cover', display: 'block', marginTop: '56px', position: 'relative', zIndex: 2 }} />
