...
const Footer = () => {
  ...
  const handleLinkClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    // Aquí se agregará la redirección cuando se implemente
      ...
      <div className="footer-container">
        <div className="footer-row">
          ...
          <div className="footer-col-md-3">
            <a href="#top" className="footer-logo-link" onClick={handleLinkClick}>
              <img
          ...
          <div className="footer-col-md-4">
            ...
            <div className="footer-social-icons">
              <a href="#" className="footer-social-icon-link" onClick={handleLinkClick}>
