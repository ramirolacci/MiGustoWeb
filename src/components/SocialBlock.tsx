...
const SocialBlock: React.FC = () => (
  <div className="footer-social-block">
    ...
    <div className="footer-social-icons" role="navigation" aria-label="Redes sociales">
      ...
      <a href="https://ar.linkedin.com/company/migustooficial" className="footer-social-icon-link" target="_blank" rel="noopener noreferrer" tabIndex={0} aria-label="Ir a LinkedIn">
        {/* LinkedIn SVG */}
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
