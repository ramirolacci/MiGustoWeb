  ...
  return (
    <div className={`mobile-side-menu-overlay ${isOpen ? 'open' : ''}`} onClick={handleOverlayClick}>
      <div className="mobile-side-menu" ref={menuRef}>
        ...
        <div className="mobile-side-menu-social">
          <span className="mobile-side-menu-social-title">ENCONTRANOS EN</span>
          <div className="mobile-side-menu-social-icons" role="navigation" aria-label="Redes sociales">
            <a href="https://www.facebook.com/migustoar/?locale=es_LA" target="_blank" rel="noopener noreferrer" aria-label="Ir a Facebook">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
              </svg>
            </a>
            <a href="https://www.youtube.com/@MiGustoOficial" target="_blank" rel="noopener noreferrer" aria-label="Ir a YouTube">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
            ...
            <a href="https://www.instagram.com/migustoar/?hl=es" target="_blank" rel="noopener noreferrer" aria-label="Ir a Instagram">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
            ...
            <a href="https://x.com/migustoar?lang=es" target="_blank" rel="noopener noreferrer" aria-label="Ir a Twitter">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z"/>
              </svg>
            </a>
            <a href="https://www.tiktok.com/@migustoar?lang=es" target="_blank" rel="noopener noreferrer" aria-label="Ir a TikTok">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z"/>
              </svg>
            </a>
            <a href="https://ar.linkedin.com/company/migustooficial" target="_blank" rel="noopener noreferrer" aria-label="Ir a LinkedIn">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
